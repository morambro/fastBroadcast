...
import it.unipd.vanets.framework.wificonnection.receiver.CollectionHandler;
import it.unipd.vanets.framework.wificonnection.receiver.WifiBroadcastReceiver;
...
public class AppController implements IControllerComponent {
	...
	public class SynchronizedDevicesList {
		...
		public synchronized void add(WifiP2pDevice device){
		...
		public synchronized WifiP2pDevice get(int index){
			return peers.get(index);
		}
		
		public synchronized WifiP2pDevice set(int i, WifiP2pDevice device){
