...
\begin{abstract}
%\boldmath
Testing VANETs protocols is difficult in general. A real simulation is expansive in term of money and involved resources, and most of the time a software simulation is used. In this document we describe our VANET testbed applications, an Android application and a Java Desktop application, which can be used to easy test different protocols for vehicolar networks.
To evaluate the performances of our worl, we implemented Fast Broadcast algorithm\cite{fastBroadcast}, a Vehicle-to-Vehicle Multi-
