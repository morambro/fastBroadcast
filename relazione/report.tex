...
\begin{abstract}
%\boldmath
Fast Broadcast\cite{fastBroadcast} is a Vehicle-to-Vehicle Multi-Hop Broadcast algorithm used to estimate cars' transmission range and to propagate Alert messages through vehicles reducing traversed hops. 
The aim of our work is to implement a testbed Android application to test vehicolar networking algorithms, using \direct APIs for devices connection. 
