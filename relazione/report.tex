...
\title{A smart-phone based testbed for Vehicolar Networking experimentation}
%
%
...
\author{Moreno~Ambrosin,~Fabio~De~Gaspari
...
% The paper headers
\markboth{Wirless Networks project report}
{Wirless Networks project report}
...
\begin{abstract}
%\boldmath
Testing VANETs protocols is difficult in general. A real simulation is expansive in term of money and resources involved, and most of the time a software simulation is used. In this document we describe out testbed application, an Android application and a Java Desktop application, which can be used to easy test designed VANETs protocols.
To evaluate our product's performances, we implemented Fast Broadcast algorithm\cite{fastBroadcast}, a Vehicle-to-Vehicle Multi-
...
\begin{IEEEkeywords}
Veicolar Networks, Fast Broadcast, \direct, Android.
\end{IEEEkeywords}
