...
\begin{abstract}
%\boldmath
Testing VANETs protocols is difficult in general. A real simulation is expansive in term of money and resources involved, and most of the time a software simulation is used. In this document we describe our VANETs testbed application, an Android application and a Java Desktop application, which can be used to easy test different protocols.
