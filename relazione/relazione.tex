...
\begin{abstract}
%\boldmath
Fast Broadcast\cite{fastBroadcast} is a Vehicle-to-Vehicle Multi-Hop Broadcast algorithm used to estimate cars' transmission range and to propagate messages through vehicles reducing traversed hops. The aim of our work was to implement that algorithm on Android devices
