...
Due to \direct features, the developed application performs two subsequest operations:	
\subsection{Devices connection}

Devices connection setup consists in the following operations:
	\begin{itemize}
...
When all of this operations are done, all the devices are connected and can communicate each other directly via TCP Sockets.
